        ...
        if st.button("🚀 Analyze Data", use_container_width=True):
            ...
            with st.container():
                ...
                with st.status("Generating analysis plan...") as status:
                    ...
                    - Visualizations should be generated by understading the user query and the previous task. Look for the previous steps and then generate the visualization accordingly (if required).
