                ...
                with st.container():
                    ...
                    with st.status("Generating analysis plan...") as status:
                        ...
                        Task-1: [Precise action description]
                          - Column Names: [Give all the column names used for Task-1 (If there), comma (",") separated in a list]
                ...
                if st.session_state.analysis_complete:
                    with st.container():
                        with st.status("Executing analysis...") as status:
                            ...
                            - Method .str.contains() should be used based on the user query. Think on your own when to directly compare the string or when to use .str.contains()
