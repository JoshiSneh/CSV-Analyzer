                ...
                with st.container():
                    ...
                    with st.status("Generating analysis plan...") as status:
                        ...
                        Task-1: [Precise action description]
                          - Column Names: [Give all the column names used for Task-1 (If there) "," separated in a list]
                        Task-2: [Precise action description]
                          - Column Names: [Give all the column names used for Task-2 (If there) "," separated in a list]
                        [...]
